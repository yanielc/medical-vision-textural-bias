    ...
    if (epoch + 1) % val_interval == 0:
        ...
        with torch.no_grad():
            ...
            if metric > best_metric:
                ...
                torch.save(
                    model.state_dict(),
                    os.path.join(root_dir, f"best_metric_model_Gibbs{SUFFIX}.pth"),
                )
...
plt.savefig(root_dir + f'trainLoss_and_meanValScore_Gibbs{SUFFIX}.png')
plt.show()
...
plt.savefig(root_dir + f'meanValScore_per_label_Gibbs{SUFFIX}.png')
plt.show()
