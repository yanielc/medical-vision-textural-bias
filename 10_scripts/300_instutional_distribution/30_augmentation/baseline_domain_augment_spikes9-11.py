...
from filters_and_operators import WholeTumorTCGA, RandKSpaceSpikeNoised
...
JOB_NAME = f"augment_INT{INTENSITY_A}-{INTENSITY_B}_model_sourceDist_4mods_WT"
...
train_transform = ReCompose(
    [
        ...
        RandKSpaceSpikeNoised("image", 0.1, 1.0, intensity_ranges={'image':(INTENSITY_A, INTENSITY_B)})
    ]
)
