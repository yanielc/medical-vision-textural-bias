...
from filters_and_operators import WholeTumorTCGA, SaltAndPepper 
...
print(f'''Using parameters salt-and-pepper PP = {PP} \n\n''')


JOB_NAME = f"sap{PP}_model_sourceDist_4mods_WT"
