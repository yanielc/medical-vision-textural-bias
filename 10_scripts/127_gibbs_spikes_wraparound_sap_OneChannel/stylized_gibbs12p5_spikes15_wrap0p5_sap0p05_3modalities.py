...
root_dir = '/vol/bitbucket/yc7620/90_data/52_MONAI_DATA_DIRECTORY/Task01_BrainTumour_SOFTLINKS' # to work with the extended dataset
...
print(f'''Using parameters MASK_RADIUS={MASK_RADIUS}, (IMAGE_CHAN, LABEL_CHAN) =
        ([0,1,2],1), INTENSITY={INTENSITY}, PP = {PP}, SP={SP}\n\n''')


JOB_NAME = f"stylized_model_gibbs{MASK_RADIUS}_spikes{INTENSITY}_wrap{PP}_sap{SP}_3mod_WT"
...
train_transform = Compose(
    [
        ...
        SaltAndPepper(SP),
        MultimodalSlicesd(["image", "label"], [0,1,2], 1), # all modalities but T2
    ]
)
...
train_ds = DecathlonDataset(
    root_dir='/vol/bitbucket/yc7620/90_data/52_MONAI_DATA_DIRECTORY/Task01_BrainTumour_SOFTLINKS/training',
...
val_ds = DecathlonDataset(
    root_dir='/vol/bitbucket/yc7620/90_data/52_MONAI_DATA_DIRECTORY/Task01_BrainTumour_SOFTLINKS/validation',
    task="Task01_BrainTumour",
